...
<<<<<<< HEAD
              ...
              >
                ...
                />
=======
                  selectedCity === city.name ? "border-orange-500" : "border-transparent hover:border-gray-300"
                }`}
              >
                <img src={city.img} alt={city.name} className="w-16 h-16 rounded-full object-cover mb-2" />
>>>>>>> main
